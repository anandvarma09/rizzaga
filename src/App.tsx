        ...
        <div style={{ maxWidth: '420px', width: '100%', background: 'rgba(15,23,42,0.95)', padding: '50px 40px', borderRadius: '28px', textAlign: 'center', border: '1px solid #6366f1', boxShadow: '0 0 60px rgba(99,102,241,0.4)' }}>
          ...
          <div style={{ marginBottom: '25px' }}>
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              <button onClick={() => setAgeGroup('under18')} style={{ flex: 1, padding: '14px', background: ageGroup === 'under18' ? '#22c55e' : '#334155', borderRadius: '12px', fontWeight: 'bold' }}>Under 18</button>
              <button onClick={() => setAgeGroup('18plus')} style={{ flex: 1, padding: '14px', background: ageGroup === '18plus' ? '#22c55e' : '#334155', borderRadius: '12px', fontWeight: 'bold' }}>18+</button>
            </div>
          </div>
