...
function App() {
  ...
  const generateSeed = () => {
    if (ageGroup === 'under18') {
      alert("Under 18 accounts have restricted access to 18+ content.");
    }
      ...
      <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #1a0033, #0f172a)', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
        <div style={{ maxWidth: '420px', width: '100%', background: 'rgba(15,23,42,0.95)', padding: '50px 40px', borderRadius: '28px', textAlign: 'center', border: '1px solid #6366f1', boxShadow: '0 0 60px rgba(99,102,241,0.4)' }}>
          ...
          <div style={{ marginBottom: '25px' }}>
            <p style={{ marginBottom: '10px' }}>Your Age Group:</p>
            <div style={{ display: 'flex', gap: '10px' }}>
              <button onClick={() => setAgeGroup('under18')} style={{ flex: 1, padding: '12px', background: ageGroup === 'under18' ? '#22c55e' : '#334155', borderRadius: '12px' }}>Under 18</button>
              <button onClick={() => setAgeGroup('18plus')} style={{ flex: 1, padding: '12px', background: ageGroup === '18plus' ? '#22c55e' : '#334155', borderRadius: '12px' }}>18+</button>
            </div>
          </div>
          ...
          <textarea value={inputPhrase} onChange={(e) => setInputPhrase(e.target.value)} placeholder="Paste your 12-word keyphrase..." style={{ width: '100%', height: '140px', background: '#1e2937', border: '2px solid #475569', borderRadius: '16px', padding: '18px', color: 'white', marginBottom: '20px' }} />
          ...
          <>
            ...
            <div style={{ background: '#1e2937', padding: '25px', borderRadius: '24px', marginBottom: '30px', border: '1px solid #6366f1', boxShadow: '0 10px 30px rgba(0,0,0,0.4)' }}>
              <textarea 
                ...
                style={{ width: '100%', minHeight: '140px', background: '#0f172a', border: '2px solid #475569', borderRadius: '16px', padding: '18px', color: 'white', fontSize: '18px', resize: 'vertical', boxSizing: 'border-box' }} 
              />
              <div style={{ marginTop: '12px', display: 'flex', gap: '10px' }}>
                <button onClick={() => setVisibility('everyone')} style={{ flex: 1, padding: '12px', background: visibility === 'everyone' ? '#22c55e' : '#334155', borderRadius: '12px', fontWeight: 'bold' }}>🌍 Everyone</button>
